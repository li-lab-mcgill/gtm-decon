...
def plot_fig2a_boxplot(path = "../data/fig2_data/"):
    files = sorted(os.listdir(path))
...
def plot_fig2b_boxplot(path = "../data/fig2_data/"):
    files = sorted(os.listdir(path))
    gts = {}
...
if __name__ == "__main__":
    ...
    # Generates Figure 2 components and saves in same directory.

    sns.set(rc={'figure.figsize': (11, 4), 'figure.dpi': 300})
    plot_fig2a_merged()
