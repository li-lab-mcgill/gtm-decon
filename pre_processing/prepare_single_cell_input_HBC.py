...
#Label map
#Option 3: Label map - assign to higher cell types 0 - HSPC, 1- Bcells, 2- Erythrocytes, 3 - NKcells, 4 - Tcells, 5 - Monocytes, 6 - Neutrophils
label_map={'HSC': 0, 'MPP': 0, 'CMP': 0, 'MEP': 0, 'LMPP': 0, 'MLP': 0, 'BNK': 0, 'GMP': 0, 'proB' : 1, 'preB' : 1, 'immB': 1, 'regB': 1, 'naiB': 1, 'memB': 1, 'plasma': 1, 'ery': 2, 'CLP': 3, 'NKP': 3, 'toxiNK': 3, 'kineNK': 3, 'CD4T': 4, 'CD8T': 4, 'hMDP': 5, 'cMOP': 5, 'preM': 5, 'claM': 5, 'interM': 5, 'nonM': 5, 'proN': 6, 'myeN': 6, 'metaN': 6,  'matureN': 6}

label_all =  np.array([label_map[i] for i in X['Unnamed: 0'].apply(lambda x: x.split('_')[0])])
