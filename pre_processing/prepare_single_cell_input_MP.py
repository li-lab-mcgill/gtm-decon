...
#Label map
label_map = {'alpha': 0, 'beta': 1, 'delta': 2, 'ductal': 3, 'endothelial': 4, 'gamma': 5, 'macrophage': 6 , 'activated_stellate': 7 , 'quiescent_stellate': 8, 'schwann': 9, 'T_cell': 10, 'B_cell': 11, 'immune_other': 12}
label_all =  np.array([label_map[i] for i in X['assigned_cluster']])
...
orig_X.drop('batch',axis=1,inplace=True)
