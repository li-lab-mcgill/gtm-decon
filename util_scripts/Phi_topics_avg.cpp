//Usage: 
//../../../../../MixEHR-sureLDA-GTM/Phi_3topics artificial_bulkData_trainData_JCVB0_nmar_K42_iter9_phi.csv > one
...
int main(int argc, char* argv[]) {
	...
	//Generate list of max indices for phi_file 
	if (phi_file.is_open())
	{
		while (getline(phi_file,line))
		{
			...
			if(num_topics == 2){
				...
				for(int i = 2; i < tokens.size(); i=i+4)
				{
				...
				for(int i = 2; i < tokens.size(); i=i+5)
				{
