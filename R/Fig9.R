...
### Phi matrix
f <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_GTM/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic/pp/input_phi_normalized.csv",header=FALSE)
f <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_gtm-decon/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic_prior_0.9/trainData_JCVB0_nmar_K10_iter4_phi_normalized.csv",header=FALSE)
genes <-read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_gtm-decon/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic_prior_0.9/genes.txt",header=FALSE)
...
#m <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_gtm-decon/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic_prior_0.9/trainData_trainData_JCVB0_nmar_K10_iter4_metagene_normalized.csv",header=FALSE)
m <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_gtm-decon/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic_prior_0.9/testData_trainData_JCVB0_nmar_K10_iter4_metagene_normalized.csv",header=FALSE)
row.names(m) <- row.names(clinical)
ordered_matrix <- m[order(m[,2]),]
categories <- c("Basal","ER+")
pheatmap(ordered_matrix[,c(1,2)],annotation_row = annot_row, color=colorRampPalette(c("white", "red"))(50),show_rownames = F,annotation_colors = annot_colors,fontsize = 20,fontsize_col = 20,cluster_cols = F, cluster_rows = F, labels_col = categories)

m <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/results_gtm-decon/TCGA/BRCA/DEgenes_TNBC_ER_sparse_75p/1topic_prior_0.9/testData_trainData_JCVB0_nmar_K10_iter4_metagene.csv",header=FALSE)
row.names(m) <- row.names(clinical)
#reordered_matrix <- m[order(m[,2]),] #Re-order on the basis of segerstolpe
#categories <- c("TNBC - T1", "T2", "T3", "T4", "T5","ER+ - T1", "T2", "T3", "T4", "T5")
...
pheatmap(reordered_matrix[1:10],annotation_row = annot_row, color=colorRampPalette(c("white", "red"))(50),show_rownames = F,annotation_colors = annot_colors,fontsize = 12,fontsize_col = 12,cluster_cols = F, labels_col = categories,cluster_rows = F)
...
write.csv(all_pvals,file="~/Swapna/WORK/McGill/projects/GTM_decon/manuscript/figures/Fig8_all_pvals_n100000.csv")
write.csv(all_pvals_lt0.05,file="~/Swapna/WORK/McGill/projects/GTM_decon/manuscript/figures/Fig8_all_pvals_lt0.05_n100000.csv")

all_pvals_lt0.05 <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/manuscript/figures/Fig8_all_pvals_lt0.05_n100000.csv")
...
deseq2 <- read.csv(file="~/Swapna/WORK/McGill/projects/GTM_decon/scripts/figures/DEgenes_BRCA_ER_vs_TNBC_together.csv",header=TRUE)
